...
export default function CyberCrimesPage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Cyber Crimes" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Cyber Crimes Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Expert legal assistance for cyber fraud, data theft, IT Act violations, and internet-based offenses.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    As digital transactions and interactions increase, so do cyber-related offenses. Being accused of a cyber crime or being a victim of digital fraud can be overwhelming due to the technical and legal complexities involved. The Information Technology Act covers a wide range of offenses from hacking to online harassment.
                                </p>
                                <p>
                                    Lawcraft Advocates offers specialized legal services for cyber crime matters. We understand the technical nuances of digital evidence and provide robust representation for clients facing charges under the IT Act or IPC, as well as for victims seeking justice for online fraud.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Defense in IT Act Cases (Section 66A, 67, etc.)",
                                    "Handling Cyber Fraud & Phishing Complaints",
                                    "Data Theft & Intellectual Property Breach",
                                    "Online Defamation & Harassment",
                                    "Cyber Stalking & Bullying Cases",
                                    "Cryptocurrency Fraud Matters",
                                    "Reporting to Cyber Crime Cells",
                                    "Bail in Cyber Crime Matters"
                                ].map((service, index) => (
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                {[
                                    {
                                        title: "Tech-Legal Expertise",
                                        desc: "We bridge the gap between technology and law to build specific defenses based on digital evidence.",
                                    },
                                    {
                                        title: "Cyber Cell Liaison",
                                        desc: "We are experienced in dealing with Cyber Crime Cells and understanding their investigation protocols.",
                                    },
                                    {
                                        title: "Privacy Focused",
                                        desc: "We prioritize client confidentiality, especially in sensitive matters like data breaches or harassment.",
                                    },
                                    {
                                        title: "Comprehensive Remedies",
                                        desc: "We assist not just in defense but also in the recovery of funds lost to online financial fraud.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Evidence Preservation", desc: "Securing digital footprints and records." },
                                    { step: "02", title: "Complaint Filing", desc: "Drafting complaints to Cyber Cells/Police." },
                                    { step: "03", title: "Legal Representation", desc: "Appearing in court for bail or trial." },
                                    { step: "04", title: "Cyber Forensics", desc: "Collaborating with experts for technical proof." },
                                ].map((item) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced Cyber Crimes lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Help with Cyber Issues?
                            </h2>
