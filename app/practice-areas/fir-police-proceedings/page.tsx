...
export default function FIRAndPolicePage() {
    return (
        <>
            <Header
            ...
            <Breadcrumb currentPageTitle="FIR & Police Proceedings" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                FIR & Police Proceedings Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Providing immediate legal protection and guidance during police investigations and FIR registration matters.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Protecting Your Rights in FIR & Police Matters
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    The registration of an FIR is the first critical step in the criminal justice process. Whether you are a complainant seeking to register a case or an individual facing a false complaint, timely legal assistance is critical. Police procedures can be intimidating, and any misstep at this stage can have long-term consequences.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we ensure that your rights are protected during police interactions. We assist in the proper registration of FIRs for victims and provide robust defense strategies for those wrongly accused, ensuring procedural correctness and fair treatment.
                                </p>
                            </div>
                        </div>
                    </Container>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    ...
                                    "Complaint to Magistrate (Section 156(3) CrPC)",
                                    "Representation during Police Interrogation",
                                    "Zero FIR Registration Assistance",
                                    "Protection from Illegal Detention",
                                    "Monitoring of Police Investigation",
                                    "Handling Police Harassment Complaints"
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We understand that police matters require immediate attention and availability.",
                                    },
                                    {
                                        title: "Procedural Accuracy",
                                        desc: "We ensure that all police procedures adhere strictly to the law and Supreme Court guidelines.",
                                    },
                                    {
                                        title: "Ethical Defense",
                                        desc: "We provide an honest assessment and defense focused on protecting your fundamental rights.",
                                    },
                                    {
                                        title: "Clear Communication",
                                        desc: "We decode legal complexities and keep you informed about every step of the investigation.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Immediate Consultation", desc: "Understanding the urgency and facts." },
                                    { step: "02", title: "Procedural Planning", desc: "Deciding on FIR registration or defense." },
                                    { step: "03", title: "Representation", desc: "Accompanying you to the police station or court." },
                                    { step: "04", title: "Follow-up", desc: "Monitoring the status of the investigation." },
                                ].map((item) => (
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="flex flex-wrap justify-center gap-4">
                                {[
                                    "Police Stations (All Jurisdictions)",
                                    "Magistrate Courts",
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced FIR & Police Proceedings lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Assistance with Police Matters?
                            </h2>
