...
export default function ArbitrationPage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Arbitration & Commercial Litigation" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Arbitration & Commercial Litigation Lawyers in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Robust legal representation for high-stakes business disputes and alternative dispute resolution.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    Commercial disputes can derail business operations and drain resources. Effective resolution requires a strategy that balances aggressive litigation with pragmatic negotiation. Whether through arbitration or court trails, the goal is always clear: protecting commercial interests.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we handle domestic and international arbitration as well as litigation in Commercial Courts. We understand the nuances of the Arbitration and Conciliation Act and are adept at enforcing awards and securing interim relief.
                                </p>
                            </div>
                        </div>
                    </Container>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    ...
                                    "Appointing Arbitrators (Section 11 petitions)",
                                    "Interim relief applications (Section 9 petitions)",
                                    "Shareholder & Boardroom disputes litigation",
                                    "Breach of contract & specific performance suits",
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We assess the commercial viability of litigation before advising on a course of action.",
                                    },
                                    {
                                        title: "Sector Expertise",
                                        desc: "Experience across construction, energy, telecom, and technology sectors.",
                                    },
                                    {
                                        title: "Agile Representation",
                                        desc: "Quick to act for seeking stay orders and injunctions to protect assets.",
                                    },
                                    {
                                        title: "Alternative Resolution",
                                        desc: "Skilled in mediation and settlement negotiations to save time and costs.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Case Analysis", desc: "Evaluating merits and risks of the dispute." },
                                    { step: "02", title: "Notice Invocation", desc: "Triggering arbitration or legal clauses." },
                                    { step: "03", title: "Representation", desc: "Pleading the case before the tribunal/court." },
                                    { step: "04", title: "Enforcement", desc: "Ensuring the final award/decree is executed." },
                                ].map((item) => (
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-gray-600 mb-10">
                                Advocating for you across forums.
                            </p>
                            <div className="flex flex-wrap justify-center gap-4">
                                {[
                                    "Arbitral Tribunals (Ad-hoc & Institutional)",
                                    "Commercial Courts",
                                    "High Courts (Original & Appellate)",
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Companies looking for Arbitration lawyers in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for expert dispute resolution.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Support for Commercial Disputes?
                            </h2>
                            <p className="text-xl text-gray-600 mb-10">
                                Resolve your disputes effectively. Connect with us today.
                            </p>
