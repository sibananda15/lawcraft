...
export default function FamilyLawPage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Family & Matrimonial Law" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Family & Matrimonial Law Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Sensitive and strong legal representation for divorce, child custody, maintenance, and domestic dispute matters.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Protecting Your Rights in Family & Matrimonial Law Matters
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    Family disputes are emotionally challenging and legally complex. Whether it is a contested divorce, a battle for child custody, or issues related to dowry harassment, the outcome can shape your future. These sensitive matters require a lawyer who combines empathy with aggressive legal defense.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we understand the delicate nature of matrimonial cases. We provide balanced legal counsel to help you navigate the Indian legal system, ensuring your dignity and rights are protected throughout the legal process.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Contested & Mutual Consent Divorce",
                                    "Child Custody & Visitation Rights",
                                    "Maintenance & Alimony Claims (Sec 125 CrPC)",
                                    "Domestic Violence Act (DV Act) Cases",
                                    "Dowry Prohibition & 498A Defense",
                                    "Restitution of Conjugal Rights (RCR)",
                                    "Judicial Separation Proceedings",
                                    "Court Marriage & Registration Support"
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We treat every family matter with the utmost privacy and discretion it deserves.",
                                    },
                                    {
                                        title: "Compassionate Approach",
                                        desc: "We listen to your story with empathy and fight for your rights with determination.",
                                    },
                                    {
                                        title: "Strategic Resolution",
                                        desc: "We prioritize mediation and settlement where possible to save you time and emotional stress.",
                                    },
                                    {
                                        title: "Courtroom Excellence",
                                        desc: "If settlement fails, we provide robust representation in Family Courts across India.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Consultation & Review", desc: "Understanding the marital history and disputes." },
                                    { step: "02", title: "Legal Strategy", desc: "Advising on divorce, custody, or settlement options." },
                                    { step: "03", title: "Representation", desc: "Filing petitions and appearing in Family Courts." },
                                    { step: "04", title: "Resolution", desc: "Securing a favorable decree or settlement." },
                                ].map((item) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced Family & Matrimonial Law lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Assistance with Family & Matrimonial Law?
                            </h2>
