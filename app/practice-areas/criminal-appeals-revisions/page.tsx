...
export default function CriminalAppealsPage() {
    return (
        <>
            <Header
            ...
            <Breadcrumb currentPageTitle="Criminal Appeals & Revisions" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Criminal Appeals & Revisions Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Challenging lower court verdicts and seeking justice through appellate jurisdictions in High Courts and the Supreme Court.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    A conviction by a lower court is often not the end of the road. If the trial court's judgment is flawed in law or fact, an appeal is the mechanism to rectify it. Revisional jurisdiction allows superior courts to examine the correctness, legality, or propriety of any finding or order.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we specialize in criminal appellate practice. We meticulously examine trial records, identify legal errors, and formulate substantial questions of law to argue before the High Courts and the Supreme Court of India.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Criminal Appeals in High Court",
                                    "Special Leave Petitions (SLP) – Criminal",
                                    "Criminal Revision Petitions",
                                    "Appeals Against Conviction",
                                    "Appeals Against Acquittal",
                                    "Suspension of Sentence Applications",
                                    "Review Petitions & Curative Petitions",
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                {[
                                    {
                                        title: "Appellate Expertise",
                                        desc: "We have substantial experience in drafting and arguing complex appeals before superior courts.",
                                    },
                                    {
                                        title: "Legal Research",
                                        desc: "Appeals are won on points of law. Our diligent research ensures every relevant precedent is cited.",
                                    },
                                    {
                                        title: "Record Analysis",
                                        desc: "We comb through trial court records to find contradictions and errors that can overturn a verdict.",
                                    },
                                    {
                                        title: "Realistic Guidance",
                                        desc: "We provide honest advice on the merits of an appeal and the likelihood of success.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Judgment Review", desc: "Analyzing the lower court's order for errors." },
                                    { step: "02", title: "Drafting Appeal", desc: "Structuring grounds of appeal and legal questions." },
                                    { step: "03", title: "Admission Hearing", desc: "Arguing for admission and stay/bail." },
                                    { step: "04", title: "Final Arguments", desc: "Detailed arguments on merits for reversal." },
                                ].map((item) => (
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="flex flex-wrap justify-center gap-4">
                                {[
                                    "Sessions Courts (Appeals from Magistrate)",
                                    "High Courts (Appeals & Revisions)",
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced Criminal Appeals & Revisions lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Seeking to Challenge a Court Order?
                            </h2>
