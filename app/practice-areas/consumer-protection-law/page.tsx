...
export default function ConsumerLawPage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Consumer Protection Law" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Consumer Protection Law Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Fighting against unfair trade practices, service deficiencies, and defective goods for your rightful compensation.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Protecting Your Rights in Consumer Protection Law Matters
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    As a consumer, you have the right to quality goods and services. However, companies often evade responsibility when things go wrong. From denied insurance claims to builder delays and defective products, standing up to corporations requires legal expertise.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we empower consumers. We take on unfair trade practices and help you secure the compensation and mental peace you deserve through effective representation in Consumer Commissions.
                                </p>
                            </div>
                        </div>
                    </Container>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    ...
                                    "Deficiency in Service Cases",
                                    "Unfair Trade Practices Litigation",
                                    "Real Estate & Builder Delay Disputes",
                                    "Insurance Claim Rejection",
                                    "Medical Negligence Cases",
                                    "E-commerce Dispute Resolution",
                                    "Appeals to State & National Commissions"
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We stand firmly by the side of the individual against large corporations and service providers.",
                                    },
                                    {
                                        title: "Proven Results",
                                        desc: "We have successfully secured refunds, interest, and compensation for numerous clients.",
                                    },
                                    {
                                        title: "Clear Guidance",
                                        desc: "We explain your chances of success honestly before you file a complaint.",
                                    },
                                    {
                                        title: "Cost-Effective",
                                        desc: "Our legal fee structures are designed to be accessible for consumer matters.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Case Evaluation", desc: "Assessing the merits of your consumer complaint." },
                                    { step: "02", title: "Legal Notice", desc: "Sending a formal notice to the opposite party." },
                                    { step: "03", title: "Filing Complaint", desc: "Approaching the appropriate Consumer Forum." },
                                    { step: "04", title: "Arguments", desc: "Representing your case to secure the order." },
                                ].map((item) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced Consumer Protection Law lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Assistance with Consumer Protection Law?
                            </h2>
