...
export default function TrialDefensePage() {
    return (
        <>
            <Header
            ...
            <Breadcrumb currentPageTitle="Trial & Criminal Defense" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Trial & Criminal Defense Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Diligent and robust defense representation in criminal trials, ensuring fair hearings and rigorous cross-examination.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    A criminal trial dictates the difference between conviction and acquittal. The quality of legal representation during the trial stage is paramount. It involves dissecting evidence, challenging the prosecution's narrative, and ensuring that procedural lapses are highlighted.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we offer dedicated trial advocacy. We believe that every accused is innocent until proven guilty, and we fight tirelessly to uphold this principle. From cross-examination of witnesses to final arguments, our focus is on uncovering the truth and securing justice.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Defense in Sessions Trials",
                                    "Defense in Magistrate Trials",
                                    "Cross-Examination of Witnesses",
                                    "Discharge Applications",
                                    "Challenging Evidence Admissibility",
                                    "Preparing Written Arguments",
                                    "Handling Warrant Cases",
                                    "Defense in Private Complaints"
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We leave no stone unturned in analyzing the charge sheet and police report.",
                                    },
                                    {
                                        title: "Expert Cross-Examination",
                                        desc: "The art of trial lies in questioning; we ensure prosecution witnesses are thoroughly tested.",
                                    },
                                    {
                                        title: "Evidence Focused",
                                        desc: "We focus on scientific evidence, procedural flaws, and contradictions to build a defense.",
                                    },
                                    {
                                        title: "Fearless Advocacy",
                                        desc: "We represent our clients with unwavering commitment and professional aggression in court.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Charge Sheet Review", desc: "Detailed analysis of the accusations." },
                                    { step: "02", title: "Defense Strategy", desc: "Identifying weaknesses in the prosecution case." },
                                    { step: "03", title: "Trial Proceedings", desc: "Evidence recording and cross-examination." },
                                    { step: "04", title: "Final Arguments", desc: "Presenting the case for acquittal." },
                                ].map((item) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced Trial & Criminal Defense lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Representation for a Trial?
                            </h2>
