...
export default function WhiteCollarCrimePage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="White Collar Crimes" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                White Collar Crimes Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Specialized defense for corporate fraud, corruption, embezzlement, and other financial crime allegations.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Protect Your Reputation in Financial Investigations
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    White-collar crime investigations often target professionals and corporations, carrying severe reputational and legal risks. Allegations of fraud, bribery, or money laundering require a sophisticated legal defense that understands both criminal law and corporate finance.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we provide discrete and effective representation in complex financial crime matters. We navigate investigations by agencies like the CBI, ED, and SFIO, working to shield our clients from unwarranted prosecution and asset attachment.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Defense in Money Laundering Cases (PMLA)",
                                    "Corporate Fraud Investigations",
                                    "Prevention of Corruption Act Matters",
                                    "Embezzlement & Misappropriation Defense",
                                    "Representing before CBI & ED",
                                    "SFIO Investigations",
                                    "Bank Fraud & Loan Default Cases",
                                    "Whistleblower Protection & Internal Enquiries"
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We combine knowledge of criminal procedure with an understanding of financial and corporate records.",
                                    },
                                    {
                                        title: "Strategic Containment",
                                        desc: "We aim to contain the investigation and prevent it from spiraling into a media trial.",
                                    },
                                    {
                                        title: "Agency Experience",
                                        desc: "We are experienced in handling interrogations and summons by central investigative agencies.",
                                    },
                                    {
                                        title: "Asset Protection",
                                        desc: "We fight against the arbitrary attachment and freezing of personal and business assets.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Record Analysis", desc: "Reviewing financial documents and allegations." },
                                    { step: "02", title: "Agency Representation", desc: "Responding to summons and attending enquiries." },
                                    { step: "03", title: "Legal Defense", desc: "Challenging FIRs and seeking anticipatory bail." },
                                    { step: "04", title: "Trial Advocacy", desc: "Defense in Special Courts for PMLA/CBI cases." },
                                ].map((item) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced White Collar Crimes lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Assistance with Financial Investigations?
                            </h2>
