...
export default function MergersAcquisitionsPage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Mergers & Acquisitions" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Mergers & Acquisitions Lawyers in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Strategic legal counsel for seamless business integrations, asset acquisitions, and corporate restructuring.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Strategic Legal Support in M&A
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    Mergers and acquisitions are transformative events that define the future trajectory of a business. However, they are fraught with legal complexities ranging from due diligence oversights to post-merger integration issues.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we provide end-to-end legal support for M&A transactions. We guide buyers, sellers, and investors through the deal lifecycle, ensuring that the transaction is legally compliant, tax-efficient, and commercially viable.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Legal Due Diligence (LDD) for buyers & sellers",
                                    "Drafting Term Sheets, SHA, and SPA",
                                    "Business Transfer Agreements (Slump Sale)",
                                    "Scheme of Amalgamation & Demergers",
                                    "Regulatory approvals (NCLT, CCI, RBI)",
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We look beyond the papers to understand the commercial value and risks of the deal.",
                                    },
                                    {
                                        title: "Comprehensive Diligence",
                                        desc: "Uncovering hidden liabilities in tax, labour, and IP before you sign the check.",
                                    },
                                    {
                                        title: "Regulatory Navigation",
                                        desc: "Expert handling of approvals from Competition Commission and Sectoral Regulators.",
                                    },
                                    {
                                        title: "Closing Efficiency",
                                        desc: "Structuring the deal to ensure a smooth closing and successful transfer of control.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Structuring", desc: "Designing the deal for tax and legal efficiency." },
                                    { step: "02", title: "Due Diligence", desc: "Verifying assets, liabilities, and compliances." },
                                    { step: "03", title: "Documentation", desc: "Negotiating and drafting transaction agreements." },
                                    { step: "04", title: "Execution", desc: "Obtaining approvals and closing the deal." },
                                ].map((item) => (
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-gray-600 mb-10">
                                We manage the regulatory landscape for your transaction.
                            </p>
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Companies looking for M&A lawyers in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for seamless deal execution.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Support for M&A Transactions?
                            </h2>
                            <p className="text-xl text-gray-600 mb-10">
                                Execute your deal with precision. Connect with us today.
                            </p>
