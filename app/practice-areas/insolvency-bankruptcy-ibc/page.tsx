...
export default function IBCPage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Insolvency & Bankruptcy (IBC)" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Expert representation for creditors and corporate debtors under the Insolvency and Bankruptcy Code (IBC).
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Efficient Resolution of Debt & Insolvency
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    The Insolvency and Bankruptcy Code, 2016 has revolutionized debt resolution in India. For operational and financial creditors, it offers a swift mechanism to recover dues. For distressed companies, it provides a structured path for revival or liquidation.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we specialize in IBC litigation. We represent banks, operational creditors, and corporate applicants before the NCLT. Our approach is focused on timely intervention and maximizing value recovery.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Filing applications under Section 7, 9 & 10 of IBC",
                                    "Defense against insolvency petitions",
                                    "Representation in Committee of Creditors (CoC)",
                                    "Advisory for Resolution Professionals (RP)",
                                    "Drafting & submission of Resolution Plans",
                                    "Liquidation process advisory",
                                    "Personal insolvency & bankruptcy advisory",
                                    "Attending NCLT & NCLAT hearings",
                                ].map((service, index) => (
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                {[
                                    {
                                        title: "IBC Specialists",
                                        desc: "We possess in-depth understanding of the evolving jurisprudence of the Insolvency Code.",
                                    },
                                    {
                                        title: "Strategic Filing",
                                        desc: "Ensuring applications are technically sound to avoid dismissal on procedural grounds.",
                                    },
                                    {
                                        title: "Creditor Protection",
                                        desc: "Aggressively pursuing the rights of financial and operational creditors.",
                                    },
                                    {
                                        title: "Revival Focus",
                                        desc: "Helping distressed entities explore viable restructuring options before liquidation.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Demand Notice", desc: "Issuing formal notice under Section 8 of IBC." },
                                    { step: "02", title: "Petition Filing", desc: "Filing the application with NCLT." },
                                    { step: "03", title: "Admission", desc: "Arguing for the commencement of CIRP." },
                                    { step: "04", title: "Resolution", desc: "Guiding through the moratorium and plan approval." },
                                ].map((item) => (
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-gray-600 mb-10">
                                Representing clients in specialized tribunals for insolvency matters.
                            </p>
                            <div className="flex flex-wrap justify-center gap-4">
                                {[
                                    "NCLT (Principal & Regional Benches)",
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Companies looking for Insolvency lawyers in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for effective debt resolution.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Facing Insolvency Challenges?
                            </h2>
                            <p className="text-xl text-gray-600 mb-10">
                                Get expert legal guidance under IBC. Connect with us today.
                            </p>
