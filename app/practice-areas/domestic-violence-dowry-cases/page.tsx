...
export default function DomesticViolencePage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Domestic Violence & Dowry Cases" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Domestic Violence & Dowry Cases Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Sensitive and strong legal representation for victims of domestic abuse and families facing false 498A complaints.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Protecting Rights in Matrimonial Criminal Disputes
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    Matrimonial disputes often escalate into criminal complaints involving allegations of cruelty, dowry demands, and domestic violence. These cases are emotionally charged and have serious legal repercussions for all parties involved. Whether seeking protection order or defending against a false FIR, experienced legal counsel is vital.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we approach these sensitive matters with empathy and legal precision. We assist women in securing protection under the DV Act and equally represent husbands and their families in defending against misuse of Section 498A IPC.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Defense in 498A IPC Cases (Cruelty)",
                                    "Domestic Violence Act (PWDV) Petitions",
                                    "Dowry Prohibition Act Matters",
                                    "Anticipatory Bail in Matrimonial FIRs",
                                    "Quashing of False 498A FIRs",
                                    "Maintenance Claims (Section 125 CrPC)",
                                    "Child Custody in Matrimonial disputes",
                                    "Mediation & Settlement Counseling"
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We handle cases with emotional intelligence while maintaining a focus on legal rights and facts.",
                                    },
                                    {
                                        title: "Protection Against Misuse",
                                        desc: "We aggressively defend legally against the misuse of gender-centric laws for personal vendettas.",
                                    },
                                    {
                                        title: "Settlement Focused",
                                        desc: "Where possible, we encourage mediation to resolve disputes amicably without prolonged litigation.",
                                    },
                                    {
                                        title: "Comprehensive Support",
                                        desc: "We provide an end-to-end legal umbrella covering criminal defense, divorce, and custody.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Consultation", desc: "Understanding the marital history and incidents." },
                                    { step: "02", title: "Immediate Relief", desc: "Applying for protection orders or anticipatory bail." },
                                    { step: "03", title: "Evidence Gathering", desc: "Collecting proof to substantiate claims or defense." },
                                    { step: "04", title: "Resolution", desc: "Fighting the case in court or facilitating settlement." },
                                ].map((item) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced Domestic Violence & Dowry Cases lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Facing a Matrimonial Legal Crisis?
                            </h2>
