...
export default function EmploymentLawPage() {
    return (
        <>
            ...
            <Breadcrumb currentPageTitle="Employment & Labour Law" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Employment & Labour Law Lawyers in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Comprehensive advisory for managing workforce legalities, employment contracts, and workplace compliance.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="font-serif text-3xl font-bold text-gray-900 mb-8">
                                Strategic Legal Support in Employment Law
                            </h2>
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    Managing human capital is one of the most significant challenges for any organization. From hiring to termination, every stage of employment is governed by a complex web of central and state laws.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we help employers navigate these regulations with ease. Whether you need to structure an ESOP plan, draft an HR handbook, or handle a wrongful termination suit, our team provides clear, actionable legal counsel to protect your organization’s interests.
                                </p>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    "Employment contracts & offer letters drafting",
                                    "Employee Stock Option Plans (ESOP) structuring",
                                    "Workplace policies & employee handbooks",
                                    "POSH (Prevention of Sexual Harassment) compliance",
                                    "Termination, severance & redundancy advice",
                                    "Non-compete & non-solicitation enforcement",
                                    "Labour law compliance audits",
                                    "Dispute resolution in Labour Courts & Tribunals",
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We understand the business need for a productive, disciplined, and legally compliant workforce.",
                                    },
                                    {
                                        title: "Policy Experts",
                                        desc: "Drafting policies that are not just legal, but practical for day-to-day HR operations.",
                                    },
                                    {
                                        title: "Dispute Mitigation",
                                        desc: "Handling grievances before they escalate into full-blown litigation.",
                                    },
                                    {
                                        title: "Statutory Adherence",
                                        desc: "Ensuring compliance with PF, ESI, Gratuity, and other social security laws.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "HR Audit", desc: "Assessing current employment documents." },
                                    { step: "02", title: "Policy Formation", desc: "Drafting robust policies and contracts." },
                                    { step: "03", title: "Implementation", desc: "Rolling out changes to the workforce." },
                                    { step: "04", title: "Advisory", desc: "Ongoing support for HR legal issues." },
                                ].map((item) => (
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-gray-600 mb-10">
                                Handling disputes across all relevant forums.
                            </p>
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Companies looking for Employment Law lawyers in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for workforce legal management.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Support with Employment Issues?
                            </h2>
                            <p className="text-xl text-gray-600 mb-10">
                                Manage your workforce with confidence. Connect with us today.
                            </p>
