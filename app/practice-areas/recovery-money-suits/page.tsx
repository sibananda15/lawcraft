...
export default function RecoveryLawPage() {
    return (
        <>
            <Header
            ...
            <Breadcrumb currentPageTitle="Recovery & Money Suits" />
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                Recovery & Money Suits Advocates in India
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Robust legal mechanism for recovering your dues, outstanding payments, and bad debts through Civil Courts.
                            </p>
                    ...
                    <Container>
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
                                <p className="mb-6">
                                    Unpaid dues can cripple a business or an individual’s financial stability. Whether it is a bounced cheque, an unpaid invoice, or a personal loan default, recovering your money requires swift and legally sound action. Delay often leads to the loss of your right to claim.
                                </p>
                                <p>
                                    At Lawcraft Advocates, we specialize in fast-tracking money recovery. We utilize all available legal tools—from Negotiable Instruments Act to Summary Suits—to ensure your hard-earned money is returned with interest.
                                </p>
                            </div>
                        </div>
                    </Container>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                {[
                                    ...
                                    "Attachment of Property Orders",
                                    "Arbitration in Debt Disputes"
                                ].map((service, index) => (
                                ...
                                {[
                                    {
                                        ...
                                        desc: "We understand the value of time in money matters and push for summary procedures.",
                                    },
                                    {
                                        title: "Strategic Pressure",
                                        desc: "Our legal notices often lead to settlements without the need for prolonged trials.",
                                    },
                                    {
                                        title: "Comprehensive Recovery",
                                        desc: "We don't just get a judgment; we work on execution to get money into your account.",
                                    },
                                    {
                                        title: "Clear Fee Structure",
                                        desc: "Transparent billing with no hidden costs for recovery litigation.",
                                    },
                                ].map((item, index) => (
                    ...
                    <Container>
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                {[
                                    { step: "01", title: "Evidence Review", desc: "Verifying invoices, cheques, and agreements." },
                                    { step: "02", title: "Legal Notice", desc: "A strong demand notice to the debtor." },
                                    { step: "03", title: "Filing Suit", desc: "Initiating Summary or Ordinary recovery suit." },
                                    { step: "04", title: "Execution", desc: "Attaching assets to recover the amount." },
                                ].map((item) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 text-center max-w-4xl mx-auto">
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Clients searching for an experienced Money Recovery lawyer in cities such as Delhi, Mumbai, Bengaluru, Lucknow, Prayagraj, or Kanpur approach Lawcraft Advocates for structured legal advice and court-focused representation.
                                </p>
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Need Legal Assistance with Recovery Suits?
                            </h2>
